...
public class Fragment_Faq extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener ,SwipeRefreshLayout.OnRefreshListener{
    ...
    public ArrayList<ListNoticeFaq> itemadd(String keyword){
        try {
            ArrayList<ListNoticeFaq> lostListItems = (ArrayList<ListNoticeFaq>) new DownLoadList().execute("faq", String.valueOf(pageNo),keyword).get();
