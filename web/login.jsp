...
<![endif]-->
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/login.js?ver=1.0>"></script>
</head>
<body>
  ...
  <div class="form">  
    ...
    <form id="securedLoginForm" name="securedLoginForm" action="<%=request.getContextPath()%>/member.do" method="post" style="display: none;">
